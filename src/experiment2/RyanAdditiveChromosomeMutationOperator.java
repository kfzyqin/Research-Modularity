 ...
 */
public class RyanAdditiveChromosomeMutationOperator implements ChromosomeMutationOperator<SimpleDiploid> {

    private static final char[] values = {'A','B','C','D'};
    private double probability;

    public RyanAdditiveChromosomeMutationOperator(double probability) {
