 ...
 */
public class GRNHaploidHorizontalOneGeneReproducer extends HaploidReproducer<SimpleHaploid> {
    private final int matrixSideSize;

    public GRNHaploidHorizontalOneGeneReproducer(int matrixSideSize) {
    ...
    public List<SimpleHaploid> reproduce(@NotNull List<SimpleHaploid> mates) {
        ...
        int tmpCrossIndex = crossIndex * matrixSideSize;
        while (tmpCrossIndex < crossIndex * matrixSideSize + matrixSideSize) {
