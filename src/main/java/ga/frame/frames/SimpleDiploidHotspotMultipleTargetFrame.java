 ...
 */
public class SimpleDiploidHotspotMultipleTargetFrame <C extends Chromosome> extends Frame<C> {

    public SimpleDiploidHotspotMultipleTargetFrame(@NotNull final State<C> state,
    ...
    public void evolve() {
        ...
        ((SimpleGenderHotspotMultipleTargetState) state).evaluateWithMultipleTargets(true);
        ((SimpleGenderHotspotMultipleTargetState) state).mutateExpressionMap();
        statistics.nextGeneration();
        state.record(statistics);
    }
}
