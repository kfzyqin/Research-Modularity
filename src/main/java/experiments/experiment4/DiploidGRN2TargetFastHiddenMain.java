...
import ga.operations.initializers.DiploidGRNHiddenLayerInitializer;
 ...
 */
public class DiploidGRN2TargetFastHiddenMain {
    private static final int[] target1 = {1, -1, 1};
    private static final int[] target2 = {1, -1, -1};
    ...
    private static final String summaryFileName = "Diploid-GRN-2-Target-Hidden.sum";
    private static final String csvFileName = "Diploid-GRN-2-Target-Hidden.csv";
    private static final String outputDirectory = "diploid-grn-2-target-hidden";
    private static final String mainFileName = "DiploidGRN3TargetFastMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "GRN 2 Targets Hidden Summary";
    private static final String plotFileName = "GRN-2-Target-Hidden-Chart.png";
    ...
    public static void main(String[] args) throws IOException {
        ...
        DiploidGRNInitializer initializer =
                new DiploidGRNInitializer(size, target1.length + hiddenTargetSize, edgeSize);
