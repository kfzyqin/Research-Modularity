...
public class HaploidGRNMatrixMain {
    ...
    private static final int perturbations = 10;
    private static final double perturbationRate = 0.15;
    private static final int perturbationCycleSize = 10;
    ...
    private static final int maxGen = 15;
    private static final List<Integer> thresholds = Arrays.asList(0, 3); // when to switch targets
    ...
    public static void main(String[] args) throws IOException {
        ...
        /* Population */
        Population<SimpleHaploid> population = initializer.initializeModularizedPopulation(2);
