...
public class HaploidGRN2Target10MatrixLarsonSPXMain {
    ...
    private static final String summaryFileName = "Haploid-GRN-2-Target-10-Matrix-Larson-SPX.txt";
    private static final String csvFileName = "Haploid-GRN-2-Target-10-Matrix-Larson-SPX.csv";
    private static final String outputDirectory = "haploid-grn-2-target-10-matrix-larson-spx";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "Haploid GRN 2 Target 10 Matrix Larson SPX";
    private static final String plotFileName = "Haploid-GRN-2-Target-10-Matrix-Larson-SPX.png";
