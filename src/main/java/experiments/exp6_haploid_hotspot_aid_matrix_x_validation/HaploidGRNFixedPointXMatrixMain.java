 ...
 */
public class HaploidGRNFixedPointXMatrixMain {
    ...
    private static final String outputDirectory = "haploid-grn-matrix-2-fixed-15";
    private static final String mainFileName = "HaploidGRNFixedPointXMatrixMain.java";
