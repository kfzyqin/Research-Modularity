 ...
 */
public class DiploidGRN3Target10FastSPXMain {
    ...
    private static final String summaryFileName = "Diploid-GRN-3-Target-10-Random-SPX.txt";
    private static final String csvFileName = "Diploid-GRN-3-Target-10-Random-SPX.csv";
    private static final String outputDirectory = "diploid-grn-3-target-10-random-spx";
    private static final String mainFileName = "DiploidGRN3Target10FastSPXMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "Diploid GRN 3 Targets 10 Random SPX";
    private static final String plotFileName = "Diploid-GRN-3-Target-10-Random-SPX.png";
