 ...
 */
public class DiploidGRN3Target15FastMatrixNoXMain {
    ...
    private static final String summaryFileName = "Diploid-GRN-3-Target-15-Matrix-No-X.txt";
    private static final String csvFileName = "Diploid-GRN-3-Target-15-Matrix-No-X.csv";
    private static final String outputDirectory = "diploid-grn-3-target-15-matrix-no-x";
    private static final String mainFileName = "DiploidGRN3Target15FastMatrixNoXMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "Diploid GRN 3 Targets 15 Matrix No X";
    private static final String plotFileName = "Diploid-GRN-3-Target-15-Matrix-No-X.png";
