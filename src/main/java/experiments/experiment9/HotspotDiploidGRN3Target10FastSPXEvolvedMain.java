 ...
 */
public class HotspotDiploidGRN3Target10FastSPXEvolvedMain {
    ...
    private static final String summaryFileName = "Hotspot-Diploid-GRN-3-Target-10-Evolved-SPX.txt";
    private static final String csvFileName = "Hotspot-Diploid-GRN-3-Target-10-Evolved-SPX.csv";
    private static final String outputDirectory = "hotspot-diploid-grn-3-target-10-evolved-spx";
    private static final String mainFileName = "HotspotDiploidGRN3Target10FastSPXEvolvedMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "Hotspot Diploid GRN 3 Targets 10 Evolved SPX";
    private static final String plotFileName = "Hotspot Diploid-GRN-3-Target-10-Evolved-SPX.png";
