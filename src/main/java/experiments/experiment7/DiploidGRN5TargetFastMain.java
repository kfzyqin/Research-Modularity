 ...
 */
public class DiploidGRN5TargetFastMain {
    ...
    private static final String summaryFileName = "Diploid-GRN-5-Target.sum";
    private static final String csvFileName = "Diploid-GRN-5-Target.csv";
    private static final String outputDirectory = "diploid-grn-5-target";
    private static final String mainFileName = "DiploidGRN5TargetFastMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "GRN 5 Targets Summary";
    private static final String plotFileName = "GRN-5-Target-Chart.png";
