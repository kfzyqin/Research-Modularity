 ...
 */
public class HotspotDiploidGRN5TargetFasterMain {
    ...
    private static final String summaryFileName = "Hotspot-Diploid-GRN-5-Target.sum";
    private static final String csvFileName = "Hotspot-Diploid-GRN-5-Target.csv";
    private static final String outputDirectory = "hotspot-diploid-grn-5-target";
    private static final String mainFileName = "HotspotDiploidGRN5TargetFasterMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "Hotspot GRN 5 Targets Summary";
    private static final String plotFileName = "Hotspot GRN-5-Target-Chart.png";
