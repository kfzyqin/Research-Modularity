 ...
 */
public class DiploidGRN3TargetFastMain {
    ...
    private static final String summaryFileName = "Diploid-GRN-3-Target.sum";
    private static final String csvFileName = "Diploid-GRN-3-Target.csv";
    private static final String outputDirectory = "diploid-grn-3-target";
    private static final String mainFileName = "DiploidGRN3TargetFastMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "GRN 3 Targets Summary";
    private static final String plotFileName = "GRN-3-Target-Chart.png";
