package experiments.experiment7;
 ...
 */
public class HotspotDiploidGRN3TargetFasterMain {
    ...
    private static final String summaryFileName = "Hotspot-Diploid-GRN-3-Target.sum";
    private static final String csvFileName = "Hotspot-Diploid-GRN-3-Target.csv";
    private static final String outputDirectory = "hotspot-diploid-grn-3-target";
    private static final String mainFileName = "HotspotDiploidGRN3TargetFasterMain.java";
    private static DateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss");
    private static Date date = new Date();

    private static final String plotTitle = "Hotspot GRN 3 Targets Summary";
    private static final String plotFileName = "Hotspot GRN-3-Target-Chart.png";

    private static final List<Integer> thresholds = Arrays.asList(0, 500, 2000);

    public static void main(String[] args) throws IOException {
        // Fitness Function
        FitnessFunction fitnessFunction = new GRNFitnessFunctionMultipleTargetsFast(target1, target2, target3,
        ...
        statistics.copyMainFile(mainFileName, System.getProperty("user.dir") +
                "/src/main/java/experiments/experiment7/" + mainFileName);
