 ...
 */
public class DiploidGRN3Target15FastSPXMain {
    ...
    private static final String outputDirectory = "diploid-grn-3-target-15-SPX";
    private static final String mainFileName = "DiploidGRN3Target15FastSPXMain.java";
    ...
    public static void main(String[] args) throws IOException {
        ...
        Reproducer<SimpleDiploid> reproducer = new SimpleDiploidReproducer(1.0 / target1.length);
