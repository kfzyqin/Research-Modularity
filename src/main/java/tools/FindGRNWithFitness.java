...
public class FindGRNWithFitness {
...
//
//                }
                String[] targetLine = lines.get(0);
                SimpleMaterial aMaterial = GeneralMethods.convertStringArrayToSimpleMaterial(targetLine);
                List<Double> removeNoEdgeFitnessesZhenyueSym = ModularityPathAnalyzer.removeEdgeAnalyzer(0, aMaterial,
                        fitnessFunctionZhenyueSym, true, 1700, null, false);

                if (removeNoEdgeFitnessesZhenyueSym.get(0) < 0.9463 && removeNoEdgeFitnessesZhenyueSym.get(0) > 0.9462) {
//                if (removeNoEdgeFitnessesZhenyueSym.get(0) > 0.9462) {
                    System.out.println("Fitness: " + removeNoEdgeFitnessesZhenyueSym.get(0));
