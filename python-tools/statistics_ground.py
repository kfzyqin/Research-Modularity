...
path_2 = '/Users/qin/Software-Engineering/Chin-GA-Project/generated-outputs/no-sharing-changing'
...
print omega.calculate_edge_number_significance(sample_size=30)
print omega.calculate_edge_number_std_dev_significance(sample_size=30)

print omega.calculate_fitness_significance(sample_size=30)
print omega.calculate_modularity_significance(sample_size=30)

print omega.calculate_most_modularities_significance(sample_size=30)
print omega.calculate_fittest_modularities_significance(sample_size=30)
